...
var Validator = (function () {
    ...
    function validateCheckout() {
       ...
       var email = document.getElementById("inputEmail").value;
        var passowrd =document.getElementById("inputPassword").value;


        if (email ==="") {
            messages.push("email must be format like this: example@example.com");
        }
        if (passowrd!="sa") {
      ...
      //  Localstorage.clear();
        ...
        console.log("log in!")
        Cookie.set("loginToken","Demo account",1000);
